#include "ofxSingleton/UnmanagedSingleton.h"

///A register of all active and inactive singletons
class Singleton1 : public ofxSingleton::UnmanagedSingleton<Singleton1>
{
};

OFXSINGLETON_DEFINE_UNMANAGED( Singleton1 )
...
class Class final : public Singleton < Class<N> >
{
private:
